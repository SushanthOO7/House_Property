...
window.Typekit.config = {
  a: "646866",
  fi: [43705, 43707, 43709, 43706, 43708, 43710],
  fc: [
    {
      id: 43705,
      family: "gopher",
      src:
        "https://use.typekit.net/af/88d4aa/00000000000000007735cb08/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      ...
      family: "gopher",
      src:
        "https://use.typekit.net/af/a14b08/00000000000000007735cb0c/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "500",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      ...
      family: "gopher",
      src:
        "https://use.typekit.net/af/1bcb70/00000000000000007735cb0f/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        stretch: "normal",
    ...
    },
    {
      ...
      family: "gopher",
      src:
        "https://use.typekit.net/af/f2998d/00000000000000007735cb0a/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      ...
      family: "gopher",
      src:
        "https://use.typekit.net/af/fd43d4/00000000000000007735cb0e/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "500",
        style: "italic",
        stretch: "normal",
    ...
    },
    {
      ...
      family: "gopher",
      src:
        "https://use.typekit.net/af/6b53ad/00000000000000007735cb11/30/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "italic",
        stretch: "normal",
  ...
  fn: ["gopher", ["i4", "i5", "i7", "n4", "n5", "n7"]],
  hn: "use.typekit.net",
  ht: "tk",
  js: "1.21.0",
  kt: "646866_6688dc3190333d0f653db307",
  l: "typekit",
  ps: 2,
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2024-07-06 05:59:15 UTC"}*/
